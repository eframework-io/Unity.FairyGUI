...
namespace EFramework.Unity.FairyGUI
{
    ...
    public static class UIUtility
    {
        ...
        /// <summary>
        /// SetActive 设置 UI 对象的显示状态。
        /// </summary>
        /// <param name="rootObj">UI 对象</param>
        /// <param name="active">是否显示，true 为显示，false 为隐藏</param>
        public static void SetActive(this GObject rootObj, bool active) { rootObj.visible = active; }

        /// <summary>
        /// SetActive 设置 UI 容器的显示状态。
        /// </summary>
        /// <param name="rootObj">UI 容器</param>
        /// <param name="active">是否显示，true 为显示，false 为隐藏</param>
        public static void SetActive(this GComponent rootObj, bool active) { rootObj.visible = active; }

        /// <summary>
        /// SetActive 设置 UI 容器中指定路径子对象的显示状态。
        /// </summary>
        /// <param name="rootObj">UI 容器</param>
        /// <param name="path">子对象路径</param>
        /// <param name="active">是否显示，true 为显示，false 为隐藏</param>
        public static void SetActive(this GComponent rootObj, string path, bool active) { rootObj.GetChildByPath(path).visible = active; }
    }
}
